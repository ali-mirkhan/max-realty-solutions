...
export default function EvaluationForm() {
  ...
  if (submitted) {
    return (
      <div className="bg-white border border-stone-border rounded-lg shadow-md p-8 text-center">
        ...
        <p className="text-sm text-charcoal/60 leading-relaxed">
          A senior agent will be in touch within 24-48 hours. Please check your inbox for a
          confirmation email.
        </p>
      </div>
    );
  ...
  return (
    <form
      ...
      className="bg-white border border-stone-border rounded-lg shadow-md p-6 lg:p-8 space-y-4"
    >
      <div>
      ...
      <div>
        <label className="block text-xs font-medium text-charcoal/60 mb-1">
          Anything specific about your property we should know? (renovations, lot size, etc.)
        </label>
        <textarea
          name="notes"
          rows={3}
      ...
      <p className="text-xs text-charcoal/60 text-center">
        We&apos;ll prepare your evaluation within 24-48 hours.
      </p>
    </form>
  );
}
