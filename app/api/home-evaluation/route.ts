  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 640px; margin: 0 auto;">
      <div style="background: #7D1A2D; padding: 24px; text-align: center;">
        <h1 style="color: white; margin: 0; font-size: 20px;">Home Evaluation Request</h1>
  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 640px; margin: 0 auto;">
      <div style="background: #7D1A2D; padding: 24px; text-align: center;">
        ...
        <p style="color: rgba(255,255,255,0.85); margin: 4px 0 0; font-size: 14px;">Free Home Evaluation</p>
      </div>
