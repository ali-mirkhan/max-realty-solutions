      ...
      <div className="container py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="mb-4">
              <span className="font-serif text-xl font-bold text-white">Max Realty</span>
              <span className="font-sans text-xs font-medium text-[#E8E4DE]/60 uppercase tracking-widest ml-2">
                Solutions
              </span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-[#E8E4DE]/70">
              <li>
                ...
                <a href="tel:+19055551234" className="hover:text-white transition-colors">(905) 555-1234</a>
              </li>
              <li>
                <span className="block text-[#E8E4DE]/50 text-xs uppercase tracking-wider mb-0.5">Email</span>
                <a href="mailto:info@maxrealtysolutions.ca" className="hover:text-white transition-colors">
                  info@maxrealtysolutions.ca
                </a>
              </li>
              <li>
                <span className="block text-[#E8E4DE]/50 text-xs uppercase tracking-wider mb-0.5">Office</span>
                <span>Thornhill, Ontario<br />Vaughan, ON L4J 0A1</span>
              </li>
              <li>
          ...
          <div>
            ...
            <Link href="/join" className="inline-block px-5 py-2.5 text-sm font-semibold text-white bg-burgundy rounded-md hover:bg-burgundy-dark transition-colors">
              Join Max Realty
            </Link>
          </div>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-[#E8E4DE]/10">
          <p className="text-xs text-[#E8E4DE]/40 leading-relaxed max-w-4xl">
            Max Realty Solutions is a licensed real estate brokerage registered with the Real Estate Council
            of Ontario (RECO). All agents associated with Max Realty Solutions are licensed and regulated
            under the Trust in Real Estate Services Act, 2002 (TRESA). The information provided on this
            website is for general informational purposes only and does not constitute professional advice.
            Property listings, prices, and availability are subject to change without notice.
          </p>
          <p className="text-xs text-[#E8E4DE]/30 mt-4">
            &copy; {new Date().getFullYear()} Max Realty Solutions. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
